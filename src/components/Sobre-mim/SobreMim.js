    ...
    return (
        <>
            ...
            <div className='container-sobreMim'>
                <h1 className='sobreMim-tablet'>Sobre mim</h1>
                <img className='foto-sobreMim' src='./imagens/fotoSobreMim.jpg' />
                <div className='container-sobreMim-paragrafo'>
                    <h2 className='sobreMim-pc'>Sobre mim</h2>
                    <h3 className='paragrafo-sobreMim'>
                        Olá, meu nome é Letícia Bastos, sou psicóloga infantil especialista em Análise do Comportamento Aplicada (ABA) ao Autismo. Minha trajetória com o público infantil começou ainda na graduação, e desde então venho construindo uma carreira pautada em conhecimento, dedicação e sensibilidade.
